...
func Routers() *gin.Engine {
	...
	AppGroup.Use(middleware.UserJWTAuth())
	...
	{
		appRouter.InitCustomerRouter(AppGroup, PublicGroup)
		appRouter.InitAnniversaryRouter(AppGroup)
		appRouter.InitFoodRouter(AppGroup)
		appRouter.InitOrderRouter(AppGroup)
		appRouter.InitDiaryRouter(AppGroup)
		appRouter.InitMenuRouter(AppGroup)
		appRouter.InitTargetRouter(AppGroup)
	}
