...
import (
	...
	"git.echol.cn/loser/menu-server/model/example"
	"git.echol.cn/loser/menu-server/model/example/request"
	exampleRes "git.echol.cn/loser/menu-server/model/example/response"
